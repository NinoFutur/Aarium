...
import net.mcreator.aarium.procedure.ProcedureOpstuffCommandExecuted;
		...
		public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
			...
			if (entity != null) {
				...
				});
				{
					...
					ProcedureOpstuffCommandExecuted.executeProcedure($_dependencies);
				}
			}
		}
	}
