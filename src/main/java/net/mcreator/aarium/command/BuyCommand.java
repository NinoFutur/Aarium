...
import net.mcreator.aarium.procedures.BuyCommandExecutedProcedure;
...
public class BuyCommand extends AariumModElements.ModElement {
	public BuyCommand(AariumModElements instance) {
		super(instance, 160);
	}
