...
import net.mcreator.aarium.procedure.ProcedureSuperfurnaceburnbuttonclicked;
...
public class GuiSuperfurnacegui extends ElementsAariumMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("aarium:textures/superfurnacegui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 64, this.guiTop + 33, 45, 20, "Burn"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureSuperfurnaceburnbuttonclicked.executeProcedure($_dependencies);
			}
		}
	}
