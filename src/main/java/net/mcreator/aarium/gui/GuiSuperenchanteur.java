...
import net.mcreator.aarium.procedure.ProcedureSuperenchanteurbuttonclick;
...
public class GuiSuperenchanteur extends ElementsAariumMod.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 16, 53) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 43, 35) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 142, 35) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("aarium:textures/superenchanteur.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 69, this.guiTop + 34, 60, 20, "Enchant"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureSuperenchanteurbuttonclick.executeProcedure($_dependencies);
			}
		}
	}
