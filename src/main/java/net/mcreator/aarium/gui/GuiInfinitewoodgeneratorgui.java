...
import net.mcreator.aarium.procedure.ProcedureInfinitewoodgeneratorguichangecontent;
...
public class GuiInfinitewoodgeneratorgui extends ElementsAariumMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("aarium:textures/infinitewoodgeneratorgui.png");
		@Override
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ProcedureInfinitewoodgeneratorguichangecontent.executeProcedure($_dependencies);
			}
		}
