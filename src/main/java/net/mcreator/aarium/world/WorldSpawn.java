...
public class WorldSpawn extends ElementsAariumMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension spawn is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("spawn", "_spawn", DIMID, WorldProviderMod.class, true);
