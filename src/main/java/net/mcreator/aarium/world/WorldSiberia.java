...
public class WorldSiberia extends ElementsAariumMod.ModElement {

	public static int DIMID = 49;
	public static final boolean NETHER_TYPE = false;

	public static DimensionType dtype;

	public WorldSiberia(ElementsAariumMod instance) {
		super(instance, 148);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension siberia is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("siberia", "_siberia", DIMID, WorldProviderMod.class, true);
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("extreme_hills")),
				Biome.REGISTRY.getObject(new ResourceLocation("taiga")), Biome.REGISTRY.getObject(new ResourceLocation("frozen_ocean")),
				Biome.REGISTRY.getObject(new ResourceLocation("frozen_river")), Biome.REGISTRY.getObject(new ResourceLocation("ice_flats")),
				Biome.REGISTRY.getObject(new ResourceLocation("ice_mountains")), Biome.REGISTRY.getObject(new ResourceLocation("taiga_hills")),
				Biome.REGISTRY.getObject(new ResourceLocation("smaller_extreme_hills")), Biome.REGISTRY.getObject(new ResourceLocation("taiga_cold")),
				Biome.REGISTRY.getObject(new ResourceLocation("taiga_cold_hills")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),
