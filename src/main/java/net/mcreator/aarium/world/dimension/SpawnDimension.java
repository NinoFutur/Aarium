...
public class SpawnDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:spawn")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public SpawnDimension(AariumModElements instance) {
		super(instance, 24);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("spawn"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:spawn")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:spawn"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:spawn"));
	}
