...
public class IgnisiaDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:ignisia")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public IgnisiaDimension(AariumModElements instance) {
		super(instance, 152);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("ignisia"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:ignisia")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:ignisia"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:ignisia"));
	}
