...
public class ForestiaDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:forestia")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public ForestiaDimension(AariumModElements instance) {
		super(instance, 150);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("forestia"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:forestia")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:forestia"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:forestia"));
	}
