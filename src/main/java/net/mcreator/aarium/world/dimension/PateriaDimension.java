...
public class PateriaDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:pateria")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public PateriaDimension(AariumModElements instance) {
		super(instance, 149);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("pateria"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:pateria")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:pateria"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:pateria"));
	}
