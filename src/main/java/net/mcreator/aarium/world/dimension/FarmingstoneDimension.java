...
import net.mcreator.aarium.procedures.FarmingstonePlayerEntersDimensionProcedure;
...
public class FarmingstoneDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:farmingstone")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public FarmingstoneDimension(AariumModElements instance) {
		super(instance, 27);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("farmingstone"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:farmingstone")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:farmingstone"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:farmingstone"));
	}
		...
		if (event.getTo() == type) {
			{
				...
				FarmingstonePlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
