...
public class SiberiaDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:siberia")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public SiberiaDimension(AariumModElements instance) {
		super(instance, 148);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("siberia"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:siberia")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:siberia"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:siberia"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("mountains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("taiga")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("frozen_ocean")),
