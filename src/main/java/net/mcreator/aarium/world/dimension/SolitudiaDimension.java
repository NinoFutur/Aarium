...
public class SolitudiaDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:solitudia")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public SolitudiaDimension(AariumModElements instance) {
		super(instance, 151);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("solitudia"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:solitudia")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:solitudia"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:solitudia"));
	}
