...
public class AquariaDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:aquaria")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public AquariaDimension(AariumModElements instance) {
		super(instance, 147);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("aquaria"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:aquaria")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:aquaria"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:aquaria"));
	}
