...
public class SkyariaDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:skyaria")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public SkyariaDimension(AariumModElements instance) {
		super(instance, 153);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("skyaria"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:skyaria")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:skyaria"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:skyaria"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("plains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("forest")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("river")),
