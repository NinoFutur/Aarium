...
public class FarmingobsidianDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:farmingobsidian")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public FarmingobsidianDimension(AariumModElements instance) {
		super(instance, 104);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("farmingobsidian"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:farmingobsidian")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:farmingobsidian"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:farmingobsidian"));
	}
