...
import net.mcreator.aarium.procedures.FarmingdirtPlayerEntersDimensionProcedure;
...
public class FarmingdirtDimension extends AariumModElements.ModElement {
	@ObjectHolder("aarium:farmingdirt")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public FarmingdirtDimension(AariumModElements instance) {
		super(instance, 28);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("farmingdirt"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aarium:farmingdirt")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aarium:farmingdirt"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("aarium:farmingdirt"));
	}
		...
		if (event.getTo() == type) {
			{
				...
				FarmingdirtPlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
