...
public class WorldSolitudia extends ElementsAariumMod.ModElement {
	public static int DIMID = 26;
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension solitudia is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("solitudia", "_solitudia", DIMID, WorldProviderMod.class, true);
