...
public class WorldFarmingstone extends ElementsAariumMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension farmingstone is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("farmingstone", "_farmingstone", DIMID, WorldProviderMod.class, true);
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				Biome.REGISTRY.getObject(new ResourceLocation("savanna_rock")), Biome.REGISTRY.getObject(new ResourceLocation("mesa_rock")),
