...
public class WorldPateria extends ElementsAariumMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension pateria is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("pateria", "_pateria", DIMID, WorldProviderMod.class, true);
