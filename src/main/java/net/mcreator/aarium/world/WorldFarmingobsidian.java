...
public class WorldFarmingobsidian extends ElementsAariumMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension farmingobsidian is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("farmingobsidian", "_farmingobsidian", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE2 = Blocks.OBSIDIAN.getDefaultState();
