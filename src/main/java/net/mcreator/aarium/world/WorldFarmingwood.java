...
import net.mcreator.aarium.procedure.ProcedureFarmingwoodPlayerEntersDimension;
...
public class WorldFarmingwood extends ElementsAariumMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension farmingwood is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("farmingwood", "_farmingwood", DIMID, WorldProviderMod.class, true);
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureFarmingwoodPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
	}

	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.LOG.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("forest")),
				Biome.REGISTRY.getObject(new ResourceLocation("plains")), Biome.REGISTRY.getObject(new ResourceLocation("ice_flats")),
				Biome.REGISTRY.getObject(new ResourceLocation("forest_hills")), Biome.REGISTRY.getObject(new ResourceLocation("jungle")),
