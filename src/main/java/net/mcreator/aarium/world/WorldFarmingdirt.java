...
import net.mcreator.aarium.procedure.ProcedureFarmingdirtPlayerEntersDimension;
...
public class WorldFarmingdirt extends ElementsAariumMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension farmingdirt is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("farmingdirt", "_farmingdirt", DIMID, WorldProviderMod.class, true);
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureFarmingdirtPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
	}
