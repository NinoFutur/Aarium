...
public class WorldForestia extends ElementsAariumMod.ModElement {

	public static int DIMID = 45;
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension forestia is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("forestia", "_forestia", DIMID, WorldProviderMod.class, true);
