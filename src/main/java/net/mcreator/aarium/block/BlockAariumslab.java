...
public class BlockAariumslab extends ElementsAariumMod.ModElement {
	@GameRegistry.ObjectHolder("aarium:aariumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("aarium:aariumslab_double")
	public static final Block block_slab_double = null;
	public BlockAariumslab(ElementsAariumMod instance) {
		super(instance, 3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("aariumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("aariumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("aarium:aariumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("aariumslab");
