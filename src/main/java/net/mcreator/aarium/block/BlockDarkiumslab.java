...
public class BlockDarkiumslab extends ElementsAariumMod.ModElement {
	@GameRegistry.ObjectHolder("aarium:darkiumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("aarium:darkiumslab_double")
	public static final Block block_slab_double = null;
	public BlockDarkiumslab(ElementsAariumMod instance) {
		super(instance, 6);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("darkiumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("darkiumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("aarium:darkiumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("darkiumslab");
