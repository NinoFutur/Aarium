...
public class DarkiumoreBlock extends AariumModElements.ModElement {
	@ObjectHolder("aarium:darkiumore")
	public static final Block block = null;
	public DarkiumoreBlock(AariumModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(6f, 10f).lightValue(0).harvestLevel(4)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 2)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 1, 1, 6))));
		}
	}
}
