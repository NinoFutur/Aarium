...
public class GreenscreenBlock extends AariumModElements.ModElement {
	@ObjectHolder("aarium:greenscreen")
	public static final Block block = null;
	public GreenscreenBlock(AariumModElements instance) {
		super(instance, 34);
	}
