...
public class TreechopperaxeBlockDestroyedWithToolProcedure extends AariumModElements.ModElement {
	public TreechopperaxeBlockDestroyedWithToolProcedure(AariumModElements instance) {
		super(instance, 144);
	}
