...
public class HolemakerRightClickedOnBlockProcedure extends AariumModElements.ModElement {
	public HolemakerRightClickedOnBlockProcedure(AariumModElements instance) {
		super(instance, 99);
	}
