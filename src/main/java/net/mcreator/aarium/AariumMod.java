 ...
 *
 *    Keep the ElementsAariumMod object in this class and all calls to this object
...
public class AariumMod {
	...
	@Mod.Instance(MODID)
	public static AariumMod instance;
	public ElementsAariumMod elements = new ElementsAariumMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsAariumMod.GuiHandler());
