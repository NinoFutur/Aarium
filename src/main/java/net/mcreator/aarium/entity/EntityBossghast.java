...
public class EntityBossghast extends ElementsAariumMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("aarium", "bossghast"), ENTITYID)
				.name("bossghast").tracker(640, 3, true).egg(-16777216, -16777216).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		protected void applyEntityAttributes() {
			...
			this.getEntityAttribute(SharedMonsterAttributes.FLYING_SPEED).setBaseValue(3);
		}
