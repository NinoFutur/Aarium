...
public class ItemBowoflight extends ElementsAariumMod.ModElement {
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("aarium", "entitybulletbowoflight"), ENTITYID).name("entitybulletbowoflight").tracker(64, 1, true).build());
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("aarium:bowoflight", "inventory"));
	}
