...
public class BowoflightItem extends AariumModElements.ModElement {
	@ObjectHolder("aarium:bowoflight")
	public static final Item block = null;
	@ObjectHolder("aarium:entitybulletbowoflight")
	public static final EntityType arrow = null;
	public BowoflightItem(AariumModElements instance) {
		super(instance, 33);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletbowoflight").setRegistryName("entitybulletbowoflight"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 100f, 15, 15);
