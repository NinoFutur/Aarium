...
public class HolemakerItem extends AariumModElements.ModElement {
	@ObjectHolder("aarium:holemaker")
	public static final Item block = null;
	public HolemakerItem(AariumModElements instance) {
		super(instance, 23);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				HolemakerRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
