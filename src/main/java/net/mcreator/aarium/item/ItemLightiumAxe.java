...
public class ItemLightiumAxe extends ElementsAariumMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("aarium:lightium_axe", "inventory"));
	}
